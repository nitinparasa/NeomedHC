...
.controller('ProdCtrl', ['$scope',function($scope) {
    $scope.products = [
      ...
      {sno:"6",name:"C-DOXIM 200",form:"Tablet",active_ingredient:"Cefpodoxime 200mg Blister pack",packof:"10*10 Strips"},
      ...
      {sno:"30",name:"TAZOMED 1.125gm",form:"injection",active_ingredient:"Piperacillin 1gm + Tazobactam 125mg",packof:"1 vial"},
